        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <form onSubmit={handleTosSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={tosLoading}
              className="cursor-pointer w-full rounded-lg bg-zinc-900 px-4 py-3 text-white font-medium transition-all hover:bg-zinc-700 hover:shadow-md disabled:bg-zinc-400 disabled:cursor-not-allowed dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-200 dark:disabled:bg-zinc-600"
            >
